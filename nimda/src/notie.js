...
var notie = function(){
    ...
    // notie.alert colors
    var alert_color_success_background = '#00A65A';
    var alert_color_warning_background = '#F39C12';
    var alert_color_error_background = '#DD4B39';
    var alert_color_info_background = '#00c0ef';
    ...
    alert_outer.style.right = '0';
    alert_outer.style.zIndex = '999999999';
    alert_outer.style.height = '50px';
    alert_outer.style.width = 'auto';
    ...
    alert_inner.style.padding = '12px 20px';
