...
__all__ = (
    'TimeZoneField', 'ImageField', 'CountryField', 'PositionField',
    'ChoiceField', 'StringField', 'TextField', 'WysiwygField'
)
...
class WysiwygWidget(RedactorEditor):
    def __init__(self, *args, **kwargs):
        kwargs.setdefault('redactor_options', {})
        kwargs['redactor_options']['toolbarFixed'] = False
        super().__init__(*args, **kwargs)
